...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 15, 2021 lúc 12:27 PM
...
(16, 'Minh trí', 'laiducminh1002@gmail.com', 'Xã Bình Lăng Huyện Ân Thi Tỉnh Hưng Yên', '0777444567', '202cb962ac59075b964b07152d234b70'),
(17, 'Minh trí  123', 'phongtran99932@gmail.com', 'Xã Bình Lăng Huyện Ân Thi Tỉnh Hưng Yên', '0777444567', '202cb962ac59075b964b07152d234b70'),
(20, 'ád', 'ád', 'da', 'ád', '9b2693d9d66ab4b386acbc60aec3842d'),
(21, 'minh tri', 'minhtri123', 'Thôn Bình lăng xã Tiền PHong Huyện Ân thi', '0326648389', '202cb962ac59075b964b07152d234b70'),
(22, 'minh tri', 'minhtri123@gmail.com', 'Thôn Bình lăng xã Tiền PHong Huyện Ân thi', '0777444568', '202cb962ac59075b964b07152d234b70');
...
INSERT INTO `import` (`id`, `product_id`, `amount`, `date`) VALUES
(12, 83, 10, '2021-08-10'),
(13, 86, 20, '2021-08-10');
...
(6, 1, '2021-08-13', 4700000, 0, 'Binh lang an thi hung yen', '', 'Tạ Văn Manh', 'tavanmanh421999@gmail.com', '0326648389');
...
(10, 'Manh', 'tavanmanh1111@gmail.com', '202cb962ac59075b964b07152d234b70');
...
ALTER TABLE `rating`
  ADD PRIMARY KEY (`id`),
  ADD KEY `product_id_constrain` (`product_id`);
...
--
ALTER TABLE `import`
  ADD CONSTRAINT `import_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`);
...
--
ALTER TABLE `rating`
  ADD CONSTRAINT `product_id_constrain` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`);
COMMIT;
